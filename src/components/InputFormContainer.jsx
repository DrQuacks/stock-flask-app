    ...
    async function handleSubmit(event) {
        ...
        if (buttonType === "PlotButton"){
            ...
            if (!stockNames.includes(formData.stockSymbol)){
                ...
                const resolvedDataObject = await data
                //console.log('almostResolvedData is: ',almostResolvedData)
                //const resolvedData = almostResolvedData['jsonResponse']
                console.log('resolvedDataObject is: ',resolvedDataObject)
                Object.keys(resolvedDataObject).forEach(resolvedDataKey => {
                    const resolvedData = resolvedDataObject[resolvedDataKey]
